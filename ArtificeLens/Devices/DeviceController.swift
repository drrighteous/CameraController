...
final class DeviceController: ObservableObject {
    ...
    lazy var exposurePriority = BoolCaptureDeviceProperty(properties.exposurePriority)
    lazy var exposureTime = NumberCaptureDeviceProperty(properties.exposureTime)
    lazy var irisAbsolute = NumberCaptureDeviceProperty(properties.irisAbsolute)
    ...
    func getSettings() -> DeviceSettings {
        return DeviceSettings(exposureMode: self.exposureMode.selected.rawValue,
                              exposurePriority: self.exposurePriority.isEnabled,
                              exposureTime: self.exposureTime.sliderValue,
                              iris: self.irisAbsolute.sliderValue,
    ...
    func set(_ deviceSettings: DeviceSettings) {
        ...
        if let exposurePriority = deviceSettings.exposurePriority {
            self.exposurePriority.isEnabled = exposurePriority
        }
        self.exposureTime.sliderValue = deviceSettings.exposureTime
        if let iris = deviceSettings.iris {
            self.irisAbsolute.sliderValue = iris
        }
    ...
    func resetDefault() {
        ...
        self.exposurePriority.reset()
        self.exposureTime.reset()
        self.irisAbsolute.reset()
        self.gain.reset()
